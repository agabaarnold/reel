...
function FieldLabel({
    ...
    return (
        <Label
            {...props}
            className={cn(
                "group/field-label peer/field-label flex w-fit gap-2 leading-snug has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border has-data-checked:border-primary/30 has-data-selected:border-primary/30 has-data-checked:bg-primary/5 has-data-selected:bg-primary/5 *:data-[slot=field]:p-2.5 group-data-[disabled=true]/field:opacity-50 dark:has-data-checked:border-primary/20 dark:has-data-selected:border-primary/20 dark:has-data-checked:bg-primary/10 dark:has-data-selected:bg-primary/10",
